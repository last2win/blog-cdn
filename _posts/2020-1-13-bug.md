---
layout: post
title: Python报错解决 RequestsDependencyWarning  urllib3 (1.24.3) or chardet (3.0.4) doesn't match a supported version!
categories: [Python, 行走的问题解决机]
description: Python报错解决 RequestsDependencyWarning  urllib3 (1.24.3) or chardet (3.0.4) doesn't match a supported version!
keywords: Python, urllib3, requests
---
